...
INTENT_EXAMPLES = {
    ...
    "issue_book": [ "take a new book", "i want to take a new book", "want a new book","i want to borrow", "issue book", "borrow", "can i borrow"],
    "return_book": ["i want to return", "return", "i'm returning"],
    "renew_book": ["renew my book", "extend due date", "renew"],
    "list_books": ["list all books", "show me all books", "list", "show all","list all available books"],
